...
ODM_DWS_FILE := $(srctree)/$(DRVGEN_PATH)/$(MTK_PROJECT).$(ODM_PROJECT_NAME).dws
ifneq ($(wildcard $(ODM_DWS_FILE)),)
DWS_FILE := $(ODM_DWS_FILE)
$(warning DWS_FILE change to $(ODM_DWS_FILE) )
else
$(warning ODM_DWS_FILE $(ODM_DWS_FILE) have not found)
endif
endif
