...
#define FS1601S_ID                   0x03
#define FS1603_ID                    0x05
#define FS1818_ID                    0x0a
#define FS1818_2_ID                  0x06
#define FS1860_ID                    0x07
...
int fs16xx_detect_sensor(uint8_t dev)
{
    ...
    switch((reg_id >> 8) & 0xff) {
        ...
        case FS1603_ID:
            ...
            pr_info("[%d] FS1603/FS1894/FS1871/FS1862 detected.", dev);
            break;
        case FS1818_2_ID:
        case FS1818_ID:
...
static int fs16xx_i2c_probe(struct i2c_client *i2c, const struct i2c_device_id *id)
{
    ...
    if(!ret) {// ok
        pr_info("%d-%02x probe finished.", dev_current, i2c->addr);
    } else {// failed
