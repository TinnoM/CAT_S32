...
#define LCM_DBG(fmt, arg...) \
    LCM_PRINT ("[ili9881c_hz] %s (line:%d) :" fmt "\r\n", __func__, __LINE__, ## arg)
// ---------------------------------------------------------------------------
//  Local Constants
// ---------------------------------------------------------------------------
...
#ifdef BUILD_LK
#define GPIO_LCD_ID (GPIO165 | 0x80000000)
#else
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.PLL_CLOCK=240;  //LINE </EGAFM-297> <change the mipi clock to reduce disturbing the wifi> <20160413> panzaoyan
...
struct LCM_DRIVER ili9881c_v500_hdplus_dsi_vdo_hz_lcm_drv = 
{
	.name		= "ili9881c_hdplus_dsi_vdo_hz",
