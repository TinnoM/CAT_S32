...
int himax_parse_dt(struct himax_ts_data *ts,struct himax_i2c_platform_data *pdata)
{
    ...
    pdata->abs_x_min = hx_panel_coords[0], pdata->abs_x_max = (hx_panel_coords[1]-1);
    pdata->abs_y_min = hx_panel_coords[2], pdata->abs_y_max = (hx_panel_coords[3]-1);
