...
extern int suspend_resume_done;
extern void himax_press_powerkey(void);
#endif
//=============================================================================================================
//
                                    ...
                                    size_t len, loff_t *pos)
{
	...
	if (!HX_PROC_SEND_FLAG)
	{
		...
		suspend_resume_done = 0;
		himax_press_powerkey();
		while (suspend_resume_done != 1)
		...
		private_ts->SMWP_enable = smwp_en;
#endif
