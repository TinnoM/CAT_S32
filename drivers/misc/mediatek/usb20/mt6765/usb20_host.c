...
#include "musbhsdma.h"
#include "usb20.h"
#include <linux/switch.h>	//Added by TINNO
...
static struct switch_dev otg_state; //added by TINNO
...
static void do_host_work(struct work_struct *data)
{
	...
	switch_set_state((struct switch_dev *)&otg_state, host_on);	// added by TINNO
