...
static ssize_t mmc_chipinfo_show (struct device *dev, struct device_attribute *attr, char *buf)
{
    ...
    else if(strncasecmp((const char *)tempID, "13", 2) == 0)      // 130100 is OEMid for Micron
        strcpy(vendorName , "Micron");
    else if(strncasecmp((const char *)tempID, "88", 2) == 0)      // 880100 is OEMid for Foresee 
        strcpy(vendorName , "Foresee");
    else if(strncasecmp((const char *)tempID, "f4", 2) == 0)      // f40100 is OEMid for Biwin 
...
static DEVICE_ATTR(chipinfo, S_IRUGO, mmc_chipinfo_show, NULL);  //LIUJ201810091132ADDO
//TINNO BEGIN
//WJ ADD 20190110
...
static DEVICE_ATTR(emmcinfo, S_IRUGO, mmc_emmcinfo_show, NULL);  //LIUJ201810091132ADDO
//TINNO END
...
static struct attribute *mmc_std_attrs[] = {
	...
	&dev_attr_ocr.attr,
	&dev_attr_dsr.attr,
	&dev_attr_chipinfo.attr,  //LIUJ201810091132ADDO
	&dev_attr_emmcinfo.attr, 
	NULL,
};
